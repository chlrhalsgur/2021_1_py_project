...
def Our_new_Ranking():
    window_our=Toplevel(win)
    window_our.geometry("1000x600")
...
def create_window():
    ...
    btn = Button(window, text = "Show Movie", command= Naver_movie)
    btn1 = Button(window, text = "Show Movie Ranking" command= Naver_movie_Ranking)
    btn2 = Button(window, text = "Our New Movie Ranking" command= Our_new_Ranking)
